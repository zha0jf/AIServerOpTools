...
# 6. 全局变量定义
AI_CARD_KEYWORDS="NVIDIA|10de:|Huawei|19e5:|Enrigin|1fbd:|MetaX|9999:|Iluvatar|1e3e:|Hexaflake|1faa:|Denglin|1e27:|Moore Threads|1ed5:"
...
if command -v nvidia-smi &> /dev/null; then
    ...
    print_code "sh" "检测到 Moore Threads GPU 卡\n$(mthreads-gmi)"
    print_code "sh" "Moore Threads GPU 拓扑信息\n$(mthreads-gmi topo -m)"
else
    print_status "AI卡状态" "未找到主流AI卡管理工具 (nvidia-smi, npu-smi, ersmi, mx-smi, ixsmi, hxsmi, dlsmi, mthreads-gmi)" "warn"
fi
...
if [ -d /sys/class/iommu ] && [ -n "$(ls -A /sys/class/iommu)" ]; then
    ...
    IOMMU_AI_CARD_KEYWORDS="NVIDIA|10de:|Huawei|19e5:|Enrigin|1fbd:|Denglin|1e27:|Moore Threads|1ed5:"
